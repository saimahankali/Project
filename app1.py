...
def main():
    ...
    if auth_status == "logged_in":
        ...
        elif selected_option=='Train Face Data':
            st.subheader("Train Face Data from video")
            if st.button("Train Face"):
                st.write('Note : This Process Can take upto 15-20 Minutes.')
                ...
                st.write('Training Face completed')
